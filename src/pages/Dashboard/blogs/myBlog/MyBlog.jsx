                        ...
                        <div key={blog._id} className="card mb-4">
                            <div class="m-auto overflow-hidden rounded-lg shadow-lg cursor-pointer h-90 w-60 md:w-80">
                                <Link to={`/blogs/${blog._id}`} class="block w-full h-full">
                                    <img alt="blog photo" src={blog.blogImg} class="object-cover w-full max-h-40"/>
                                    <div class="w-full p-4 bg-white dark:bg-gray-800">
                                        ...
                                        <div class="flex flex-wrap items-center mt-4 justify-starts">
                                            ...
                                            {
                                                blog.tags.map(tag => (
                                                    <div key={tag.id} class="text-xs mr-2 py-1.5 px-4 text-gray-600 bg-blue-100 rounded-2xl">
                                                        {tag}
                                                    </div>
                                                ))
                                            }
                                    ...
                                    <div class="flex items-center m-4">
                                        <a href="#" class="relative block">
                                            <img alt="profil" src={blog.userImg} class="mx-auto object-cover rounded-full h-10 w-10 "/>
                                        </a>
