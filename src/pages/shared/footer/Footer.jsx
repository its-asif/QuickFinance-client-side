    ...
    return (
        ...
        <div className="flex flex-col items-center bg-black text-white mb-0 py-8">
            ...
            <div className='flex justify-center items-center gap-5'>
                <img src={footerLogo} alt="QuickFinance Logo" />
                <h1 className='font-bold text-3xl'>QUICK<span className='text-[#399B53]'>FINANCE</span> </h1>
            </div>
            ...
            <div className="flex gap-2 md:gap-12 mt-4">
                ...
                <Link to='#' target='_blanks' className="">
